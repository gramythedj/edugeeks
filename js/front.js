  ...
  $.cookie("theme_csspath") &&
    ...
    $("#colour").change(function () {
      if ("" !== $(this).val()) {
        ...
        $("link#theme-stylesheet").attr("href", t),
          $.cookie("theme_csspath", t, { expires: 365, path: "/" });
      }
      return !1;
    }),
    $("#layout").change(function () {
      if ("" !== $(this).val()) {
        ...
        $("body").removeClass("wide"),
          ...
          $("body").addClass(t),
          $.cookie("theme_layout", t, { expires: 365, path: "/" });
      }
      return !1;
    });
}
...
function fullScreenContainer() {
  ...
  $("#intro, #intro .item").css({ width: t, height: e });
}
function utils() {
...
$.cookie("theme_csspath") &&
  $("link#theme-stylesheet").attr("href", $.cookie("theme_csspath")),
  $.cookie("theme_layout") && $("body").addClass($.cookie("theme_layout")),
  $(function () {
    sliderHomepage(),
      sliders(),
      fullScreenContainer(),
      productDetailGallery(4e3),
      menuSliding(),
      productDetailSizes(),
      utils(),
      animations(),
    ...
    $(".same-height-row").each(function () {
      ...
      e.height("auto"),
        $(window).width() > 768 &&
          ...
          e.innerHeight(t)),
        (t = 0),
        (e = $(this).find(".same-height-always")).height("auto"),
        e.each(function () {
