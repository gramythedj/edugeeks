...
}(this, function ()
{
    ...
    var t, o, n = function (e, t)
        ...
        r = function (e, t)
        {
            ...
            if (Array.prototype.map && e.map === Array.prototype.map) r = Array.prototype.map.call(e, function (e)
            {
                ...
                for (o = 0; o < s; o++) callback_params = n, callback_params.splice(0, 0, e[o]), r.push(t.apply(this, callback_params));
            return r
        },
        s = function (e)
        {
        ...
        {
            var o, n, r, s, a;
            for (o = 0; o < e.length; o++) e[o] instanceof google.maps.LatLng || (e[o].length > 0 && "object" == typeof e[o][0] ? e[o] = i(e[o], t) : e[o] = (n = e[o], r = t, s = void 0, a = void 0, s = n[0], a = n[1], r && (s = n[1], a = n[0]), new google.maps.LatLng(s, a)));
            return e
        },
        a = function (e, t)
        {
            e = e.replace("#", "");
            return "jQuery" in this && t ? $("#" + e, t)[0] : document.getElementById(e)
        },
        l = function (e)
        {
            "use strict";
            var t = document,
                o = function (e)
                {
                    ...
                    var r, s = this,
                        ...
                        c = e.el || e.div,
                        g = e.markerClusterer,
                        h = google.maps.MapTypeId[e.mapType.toUpperCase()],
                        ...
                        m = f.style || "DEFAULT",
                        y = f.position || "TOP_LEFT",
                        v = e.panControl || !0,
                        k = e.mapTypeControl || !0,
                        w = e.scaleControl || !0,
                        L = e.streetViewControl || !0,
                        b = b || !0,
                        _ = {},
                        M = {
                            zoom: this.zoom,
                        ...
                        x = {
                            ...
                            zoomControlOptions:
                            {
                                style: google.maps.ZoomControlStyle[m],
                    ...
                    if ("string" == typeof e.el || "string" == typeof e.div ? this.el = a(c, e.context) : this.el = c, void 0 === this.el || null === this.el) throw "No element defined.";
                    for (window.context_menu = window.context_menu ||
                        {}, window.context_menu[s.el.id] = {}, this.controls = [], this.overlays = [], this.layers = [], this.singleLayers = {}, this.markers = [], this.polylines = [], this.routes = [], this.polygons = [], this.infoWindow = null, this.overlay_el = null, this.zoom = e.zoom, this.registered_events = {}, this.el.style.width = e.width || this.el.scrollWidth || this.el.offsetWidth, this.el.style.height = e.height || this.el.scrollHeight || this.el.offsetHeight, google.maps.visualRefresh = e.enableNewStyle, r = 0; r < p.length; r++) delete e[p[r]];
                    for (1 != e.disableDefaultUI && (M = n(M, x)), _ = n(M, e), r = 0; r < i.length; r++) delete _[i[r]];
                    for (r = 0; r < l.length; r++) delete _[l[r]];
                    this.map = new google.maps.Map(this.el, _), g && (this.markerClusterer = g.apply(this, [this.map]));
                    var C = function (e, t)
                    {
                        var o = "",
                        ...
                        if (a("gmaps_context_menu"))
                        {
                            ...
                            {
                                var g = p[r];
                                google.maps.event.clearListeners(g, "click"), google.maps.event.addDomListenerOnce(g, "click", function (o)
                                {
                            ...
                            var h = function (e)
                                ...
                                u = h[0] + t.pixel.x - 15,
                                d = h[1] + t.pixel.y - 15;
                            l.style.left = u + "px", l.style.top = d + "px", l.style.display = "block"
                        }
                    };
                    this.buildContextMenu = function (e, t)
                    {
                        if ("marker" === e)
                        {
                            ...
                            o.setMap(s.map), o.draw = function ()
                            {
                                ...
                                t.pixel = n.fromLatLngToContainerPixel(r), C(e, t)
                            }
                        }
                        else C(e, t)
                    }, this.setContextMenu = function (e)
                    {
                        ...
                        n.id = "gmaps_context_menu", n.style.display = "none", n.style.position = "absolute", n.style.minWidth = "100px", n.style.background = "white", n.style.listStyle = "none", n.style.padding = "8px", n.style.boxShadow = "2px 2px 6px #ccc", t.body.appendChild(n);
                    ...
                    {
                        (T = i[O]) in e && P(this.map, T)
                    }
                    for (O = 0; O < l.length; O++)
                    {
                        var T;
                        (T = l[O]) in e && P(this.map, T)
                    }
                    ...
                    {
                        for (var t = e.length, o = new google.maps.LatLngBounds, n = 0; n < t; n++) o.extend(e[n]);
                    ...
                    var z, S = [];
                    for (z in this.map) "function" != typeof this.map[z] || this[z] || S.push(z);
                    for (r = 0; r < S.length; r++) ! function (e, t, o)
                    {
                        e[o] = function ()
                        {
    ...
    return l.prototype.createControl = function (e)
    {
    ...
    }, l.prototype.createMarker = function (e)
    {
        ...
        for (c = 0; c < g.length; c++) ! function (t, o)
        {
        ...
        {
            o.marker = this, e.rightclick && e.rightclick.apply(this, [o]), void 0 != window.context_menu[t.el.id].marker && t.buildContextMenu("marker", o)
    ...
    }, l.prototype.removeMarkers = function (e)
    {
        ...
        {
            for (o = 0; o < e.length; o++) this.markers.indexOf(e[o]) > -1 && this.markers[o].setMap(null);
            for (o = 0; o < this.markers.length; o++) null != this.markers[o].getMap() && t.push(this.markers[o]);
            this.markers = t
        }
    }, l.prototype.drawOverlay = function (e)
    {
        ...
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function ()
        {
            ...
            var n, r, s = this.getPanes(),
                i = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            s[e.layer].appendChild(o);
            for (var a = 0; a < i.length; a++) n = o, r = i[a], google.maps.event.addDomListener(n, r, function (e)
            {
        ...
        }, t.draw = function ()
        {
            ...
            {
                case "top":
                    r.style.top = n.y - i + e.verticalOffset + "px";
                    break;
                default:
                case "middle":
                    r.style.top = n.y - i / 2 + e.verticalOffset + "px";
                    break;
                case "bottom":
    ...
    }, l.prototype.drawCircle = function (e)
    {
        ...
        for (var t = new google.maps.Circle(e), o = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], r = 0; r < o.length; r++) ! function (t, o)
        {
            e[o] && google.maps.event.addListener(t, o, function (t)
            {
                e[o].apply(this, [t])
    ...
    }, l.prototype.drawRectangle = function (e)
    {
        ...
        e.bounds = t;
        for (var o = new google.maps.Rectangle(e), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], s = 0; s < r.length; s++) ! function (t, o)
        {
            e[o] && google.maps.event.addListener(t, o, function (t)
            {
                e[o].apply(this, [t])
    ...
    }, l.prototype.drawPolygon = function (e)
    {
        ...
        {
            map: this.map
        }, e), 0 == t && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = s(r(e.paths, i, t)));
        for (var o = new google.maps.Polygon(e), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], p = 0; p < a.length; p++) ! function (t, o)
        {
            e[o] && google.maps.event.addListener(t, o, function (t)
            {
                e[o].apply(this, [t])
        ...
        return this.polygons.push(o), l.fire("polygon_added", o, this), o
    ...
    }, l.prototype.getRoutes = function (e)
    {
        ...
        (new google.maps.DirectionsService).route(r, function (t, o)
        {
            ...
            {
                for (var n in t.routes) t.routes.hasOwnProperty(n) && s.routes.push(t.routes[n]);
    ...
    }, l.prototype.getElevations = function (e)
    {
        (e = n(
        {
            ...
            path: !1,
            samples: 256
        }, e)).locations.length > 0 && e.locations[0].length > 0 && (e.locations = s(r([e.locations], i, !1)));
        var t = e.callback;
        delete e.callback;
        ...
        if (e.path)
        {
            ...
            o.getElevationAlongPath(a, function (e, o)
            {
                t && "function" == typeof t && t(e, o)
            })
        }
        else delete e.path, delete e.samples, o.getElevationForLocations(e, function (e, o)
        {
            t && "function" == typeof t && t(e, o)
        })
    ...
    {
        var t, o = [],
            n = "http://maps.googleapis.com/maps/api/staticmap";
        ...
        if (r)
            ...
            {
                g = [], t.size && "normal" !== t.size ? (g.push("size:" + t.size), delete t.size) : t.icon && (g.push("icon:" + encodeURI(t.icon)), delete t.icon), t.color && (g.push("color:" + t.color.replace("#", "0x")), delete t.color), t.label && (g.push("label:" + t.label[0].toUpperCase()), delete t.label), h = t.address ? t.address : t.lat + "," + t.lng, delete t.address, delete t.lat, delete t.lng;
                for (var c in t) t.hasOwnProperty(c) && g.push(c + ":" + t[c]);
                g.length || 0 === u ? (g.push(h), g = g.join("|"), o.push("markers=" + encodeURI(g))) : (g = o.pop() + encodeURI("|" + h), o.push(g))
            }
        if (s)
            for (u = 0; u < s.length; u++)
            {
                var d = [];
                s[u].featureType && d.push("feature:" + s[u].featureType.toLowerCase()), s[u].elementType && d.push("element:" + s[u].elementType.toLowerCase());
                for (var f = 0; f < s[u].stylers.length; f++)
                    for (var m in s[u].stylers[f])
                    {
                        var y = s[u].stylers[f][m];
                        "hue" != m && "color" != m || (y = "0x" + y.substring(1)), d.push(m + ":" + y)
                    }
                var v = d.join("|");
                "" != v && o.push("style=" + v)
            }
        ...
        if (i)
        {
            if (t = i, i = [], t.strokeWeight && i.push("weight:" + parseInt(t.strokeWeight, 10)), t.strokeColor)
            {
                var w = k(t.strokeColor, t.strokeOpacity);
                i.push("color:" + w)
            }
            if (t.fillColor)
            {
                var L = k(t.fillColor, t.fillOpacity);
                i.push("fillcolor:" + L)
            }
            var b = t.path;
            if (b.join)
            {
                var _;
                for (f = 0; _ = b[f]; f++) i.push(_.join(","))
            }
            else i.push("enc:" + b);
            i = i.join("|"), o.push("path=" + encodeURI(i))
        }
    ...
    }, l.createPanorama = function (e)
    {
        ...
        for (var o = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], r = n(
            {
                visible: !0
            }, e), s = 0; s < o.length; s++) delete r[o[s]];
        var i = new google.maps.StreetViewPanorama(t, r);
        for (s = 0; s < o.length; s++) ! function (t, o)
        {
            e[o] && google.maps.event.addListener(t, o, function ()
            {
                e[o].apply(this)
    ...
    }, l.fire = function (e, t, o)
    {
        if (-1 == l.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2));
            ...
            for (var n = o.registered_events[e], r = 0; r < n.length; r++) s = n[r].handler, i = o, a = t, s.apply(i, [a]);
        var s, i, a
    ...
    }), google.maps.Polygon.prototype.containsLatLng || (google.maps.Polygon.prototype.containsLatLng = function (e)
    {
        ...
        for (var o = !1, n = this.getPaths().getLength(), r = 0; r < n; r++)
            for (var s = this.getPaths().getAt(r), i = s.getLength(), a = i - 1, l = 0; l < i; l++)
            {
                var p = s.getAt(l),
                    c = s.getAt(a);
