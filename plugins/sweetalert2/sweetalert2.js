...
(function (global, factory) {
  ...
  var setParameters = function (params) {
    ...
    var margin = 5; // %
    var mediaQueryMaxWidth =
      params.width + parseInt(params.width * (margin / 100) * 2, 10);
    cssNode.innerHTML =
    ...
    if (params.buttonsStyling) {
      ...
      $cancelBtn.style.backgroundColor =
        $cancelBtn.style.borderLeftColor =
        $cancelBtn.style.borderRightColor =
          "";
    }
    ...
    return new Promise(function (resolve, reject) {
      ...
      var getInput = function () {
        switch (params.input) {
          ...
          case "radio":
            return (
              modal.querySelector("." + swalClasses.radio + " input:checked") ||
              modal.querySelector(
      ...
      var onButtonEvent = function (event) {
        ...
        switch (e.type) {
          ...
          case "focus":
            if (params.buttonsStyling) {
              if (targetedConfirm) {
                target.style.backgroundColor = colorLuminance(
      ...
      sweetAlert.showValidationError = function (error) {
        var $validationError = modal.querySelector(
          "." + swalClasses.validationerror
        );
      ...
      switch (params.input) {
        ...
        default:
          console.error(
            'Unexpected type of input! Expected "text" or "email" or "password", "select", "checkbox", "textarea" or "file", got ' +
              typeof arguments[0]
          );
          break;
      }
  ...
  sweetAlert.close = sweetAlert.closeModal = function () {
    ...
    var $successIcon = modal.querySelector(
      "." + swalClasses.icon + "." + iconTypes.success
    );
    removeClass($successIcon, "animate");
    removeClass($successIcon.querySelector(".tip"), "animate-success-tip");
    removeClass($successIcon.querySelector(".long"), "animate-success-long");

    var $errorIcon = modal.querySelector(
      "." + swalClasses.icon + "." + iconTypes.error
    );
    removeClass($errorIcon, "animate-error-icon");
    removeClass($errorIcon.querySelector(".x-mark"), "animate-x-mark");

    var $warningIcon = modal.querySelector(
      "." + swalClasses.icon + "." + iconTypes.warning
    );
